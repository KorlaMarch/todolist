  ...
  render() {
    return (
      <footer className="text-center bg-dark text-light py-3 fixed-bottom">
        <i className="fa fa-copyright" aria-hidden="true" /> 2017 Khemarat Boonyapaluk PS.I Love you Michelle <a href="supersecertpagethatnoonecanopen.html" className="noA">&lt;3</a>
        <div>
